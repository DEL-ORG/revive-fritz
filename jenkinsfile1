...
cd s6-revive-chart-repo/helm-chart/ui
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/ui
  tag: ${BUILD_NUMBER} 
EOF
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/catalog
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/catalog
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/catalog-db
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/catalog-db
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/carts
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/carts
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/carts-db
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/carts-db
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/orders
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/orders
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/orders-db
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/orders-db
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/checkout
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/checkout
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/checkout-db
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/checkout-db
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/assets
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/assets
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
...
git clone git@github.com:DEL-ORG/s6-revive-chart-repo.git   
cd s6-revive-chart-repo/helm-chart/rabbitmq
cat <<EOF > dev-values.yaml
image:
  repository: 637423375996.dkr.ecr.us-east-1.amazonaws.com/rabbitmq
  tag: ${BUILD_NUMBER} 
EOF
  git config --global user.email "info@devopseasylearning.com"
  git config --global user.name "devopseasylearning"
